...
{
	private static final Logger L=Logger.getLogger(MobileSecurePayer.class);
			...
			final int myWhat, final Activity activity)
	{
		...
		if (mAlixPay == null)
		{
//			L.d("bind service "+IAlixPay.class.getName());
			boolean bindt=mActivity.bindService(new Intent("com.alipay.android.app.IAlixPay"), mAlixPayConnection, Context.BIND_AUTO_CREATE);
			if(!bindt){
				L.d("cann't bind service "+IAlixPay.class.getName());
				return false;
			}
		}
		//else ok.
