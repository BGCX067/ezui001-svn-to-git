...
@Controller
public class FortumoPayReceiverApi {
	protected static final Logger logger = LoggerFactory.getLogger(FortumoPayReceiverApi.class);
	...
	@RequestMapping(value = "/api/integrate/ftmpay/receiver", method = {
